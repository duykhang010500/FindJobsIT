		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: rgb(96, 152, 198);padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					<h4 style="margin:0">ĐƠN HÀNG CỦA BẠN ĐÃ ĐƯỢC XÁC NHẬN</h4>
					<h6 style="margin:0">Mã đơn hàng: {{$code['order_code']}}</h6>
					<h6 style="margin:0">Ngày xác nhận: {{$code['now']}}</h6>
				</div>
				...
				<div class="col-md-12">
					<p style="color:#fff;font-size: 17px;">Đơn hàng của bạn đã được xác nhận. Bạn có thể sử dụng dịch vụ của chúng tôi với thông tin như sau:</p>
